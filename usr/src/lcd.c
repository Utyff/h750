...
void LCD_Clear(const u16 color) {
...
//    return;
    ...
    const u32 totalPoints = lcddev.width * lcddev.height;  // get the total number of points
    ...
    POINT_COLOR = CYAN;
    LCD_ShowxNum(100, MAX_Y-26, LCDClearTick / DWT_IN_MICROSEC, 8, 12, 9);
}
